...
for i in pl_classes_male:
    print("""INSERT INTO classes (max_weight, division, sport) VALUES ("""+ str(i) + """,'M','PL');""")
for i in pl_classes_female:
    print("""INSERT INTO classes (max_weight, division, sport) VALUES ("""+ str(i) + """,'W','PL');""")
for i in wl_classes_male:
    print("""INSERT INTO classes (max_weight, division, sport) VALUES ("""+ str(i) + """,'M','WL');""")
for i in wl_classes_female:
    print("""INSERT INTO classes (max_weight, division, sport) VALUES ("""+ str(i) + """,'W','WL');""")
